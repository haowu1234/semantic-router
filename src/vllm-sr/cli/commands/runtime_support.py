...
PASSTHROUGH_ENV_RULES = (
    ...
    ("OPENAI_API_KEY", True),
    ("NL_PLANNER_BACKEND", False),
    ("NL_PLANNER_PROVIDER", False),
    ("NL_PLANNER_BASE_URL", False),
    ("NL_PLANNER_API_KEY", True),
    ("NL_PLANNER_MODEL", False),
    ("NL_PLANNER_TIMEOUT_MS", False),
    ("NL_PLANNER_MAX_OUTPUT_TOKENS", False),
    ("NL_PLANNER_TOOL_BUDGET", False),
    ("NL_PLANNER_ALLOW_WEB_TOOLS", False),
    ("NL_PLANNER_ALLOW_MCP_TOOLS", False),
    ("NL_PLANNER_ALLOWED_MCP_TOOLS", False),
